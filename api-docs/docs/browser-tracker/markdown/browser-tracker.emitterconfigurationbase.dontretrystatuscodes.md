...
[Home](./index.md) &gt; [@snowplow/browser-tracker](./browser-tracker.md) &gt; [EmitterConfigurationBase](./browser-tracker.emitterconfigurationbase.md) &gt; [dontRetryStatusCodes](./browser-tracker.emitterconfigurationbase.dontretrystatuscodes.md)
