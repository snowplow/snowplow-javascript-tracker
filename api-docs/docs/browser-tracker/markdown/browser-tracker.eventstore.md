...
|  --- | --- | --- |
|  [add](./browser-tracker.eventstore.add.md) | (payload: Payload) =&gt; Promise&lt;void&gt; | Add an event to the store |
|  [count](./browser-tracker.eventstore.count.md) | () =&gt; Promise&lt;number&gt; | Count all events in the store |
|  [getAll](./browser-tracker.eventstore.getall.md) | () =&gt; Promise&lt;Payload\[\]&gt; | Retrieve all events in the store |
