...
[Home](./index.md) &gt; [@snowplow/browser-tracker](./browser-tracker.md) &gt; [TrackerCore](./browser-tracker.trackercore.md) &gt; [addGlobalContexts](./browser-tracker.trackercore.addglobalcontexts.md)
