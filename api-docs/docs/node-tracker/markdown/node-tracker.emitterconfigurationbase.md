...
|  [credentials?](./node-tracker.emitterconfigurationbase.credentials.md) | "omit" \| "same-origin" \| "include" | <i>(Optional)</i> Controls whether or not the browser sends credentials (defaults to 'include') |
