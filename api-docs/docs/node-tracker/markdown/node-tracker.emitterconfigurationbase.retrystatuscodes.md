...
[Home](./index.md) &gt; [@snowplow/node-tracker](./node-tracker.md) &gt; [EmitterConfigurationBase](./node-tracker.emitterconfigurationbase.md) &gt; [retryStatusCodes](./node-tracker.emitterconfigurationbase.retrystatuscodes.md)
