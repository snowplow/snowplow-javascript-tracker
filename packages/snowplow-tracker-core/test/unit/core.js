...
const tracker = core.trackerCore(false)

// Doesn't check true timestamp
const compare = function(result, expected, message) {
    result = result.build()
...
module.exports = (function() {
    describe('Tracking events', function() {
        ...
        it('Track a structured event', function() {
            var expected = {
                e: 'se',
                se_ca: 'cat',
                se_ac: 'act',
        ...
        it('Track an ecommerce transaction event', function() {
            var orderId = 'ak0008'
            var totalValue = 50
            var taxValue = 6
            var shipping = 0
            ...
            compare(
                tracker.trackEcommerceTransaction(orderId, null, totalValue, taxValue, shipping, city, state, country, currency),
                expected,
                'A transaction event should be tracked correctly'
            )
        })

        it('Track an ecommerce transaction item event', function() {
            var orderId = 'ak0008'
            var sku = '4q345'
            var price = 17
            var quantity = 2
            ...
            compare(
                tracker.trackEcommerceTransactionItem(orderId, sku, name, category, price, quantity, currency),
                expected,
                'A transaction item event should be tracked correctly'
            )
        })

        it('Track an unstructured event', function() {
            var inputJson = {
        ...
        it('Track a self-describing event', function() {
            var inputJson = {
                schema: 'iglu:com.acme/user/jsonschema/1-0-1',
                data: {
                    name: 'Eric',
        ...
        it('Track a link click', function() {
        ...
        it('Track a screen view', function() {
            var name = 'intro'
        ...
        it('Track an ad impression', function() {
            ...
            compare(
                ...
                expected,
                'An ad impression should be tracked correctly'
            )
        })

        it('Track an ad click', function() {
            var targetUrl = 'http://adsite.com'
            ...
            compare(
                ...
                expected,
                'An ad click should be tracked correctly'
            )
        })

        it('Track an ad conversion', function() {
            ...
            compare(
                tracker.trackAdConversion(conversionId, costModel, cost, category, action, property, initialValue, advertiserId, campaignId),
                expected,
                'An ad conversion should be tracked correctly'
            )
        })

        it('Track a social interaction', function() {
            var action = 'like'
        ...
        it('Track an add-to-cart event', function() {
            var sku = '4q345'
            var unitPrice = 17
            var quantity = 2
            var name = 'red shoes'
        ...
        it('Track a remove-from-cart event', function() {
            var sku = '4q345'
            var unitPrice = 17
            var quantity = 2
            var name = 'red shoes'
        ...
        it('Track a form focus event', function() {
            var formId = 'parent'
            var elementId = 'child'
            var nodeName = 'INPUT'
            var type = 'text'
        ...
        it('Track a form change event', function() {
            var formId = 'parent'
            var elementId = 'child'
            var nodeName = 'INPUT'
            var type = 'text'
        ...
        it('Track a form submission event', function() {
            var formId = 'parent'
        ...
        it('Track a site seach event', function() {
        ...
        it('Track a consent withdrawn event', function() {
            var all = false
            var id = 1234
            var version = 2
        ...
        it('Track a consent granted event', function() {
            var id = 1234
            var version = 2
            var name = 'consent_form'
        ...
        it('Track a page view with custom context', function() {
            var url = 'http://www.example.com'
            var page = 'title page'
            var inputContext = [
                {
        ...
        it('Track a page view with a timestamp', function() {
            var tstamp = 1000000000000

            assert.strictEqual(
                tracker.trackPageView('http://www.example.com', null, null, null, tstamp).build()['dtm'],
                '1000000000000',
                'A timestamp should be attached correctly'
            )
        })

        it('Add individual name-value pairs to the payload', function() {
        ...
        it('Add a dictionary of name-value pairs to the payload', function() {
            var tracker = core.trackerCore(false)
            var url = 'http://www.example.com'
            var expected = {
                e: 'pv',
        ...
        it('Reset payload name-value pairs', function() {
            var tracker = core.trackerCore(false)
            var url = 'http://www.example.com'
            var expected = {
                e: 'pv',
        ...
        it('Execute a callback', function() {
            var callbackTarget
        ...
        it('Use setter methods', function() {
            var tracker = core.trackerCore(false)
        ...
        it('Set true timestamp', function() {
            var url = 'http://www.example.com'
            var page = 'title page'
            var result = tracker
                .trackPageView(url, page, null, null, {
                    type: 'ttm',
                    value: 1477403862,
                })
                .build()
        ...
        it('Set device timestamp as ADT', function() {
            var inputJson = {
                schema: 'iglu:com.acme/user/jsonschema/1-0-1',
                data: {
                    name: 'Eric',
            ...
            var result = tracker
                .trackSelfDescribingEvent(inputJson, [inputJson], {
                    type: 'dtm',
                    value: 1477403869,
                })
                .build()
