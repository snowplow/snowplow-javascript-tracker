...
module.exports = (function() {
    ...
    describe('Payload', function() {
        ...
        it('Do not add undefined values to a payload', function() {
            var sb = payload.payloadBuilder(false)
            sb.add('e', undefined)
        ...
        it('Do not add null values to a payload', function() {
            var sb = payload.payloadBuilder(false)
            sb.add('e', null)
        ...
        it('Add a JSON to the payload', function() {
            var sb = payload.payloadBuilder(false)
        ...
        it('Add a base 64 encoded JSON to the payload', function() {
