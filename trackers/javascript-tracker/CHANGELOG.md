...
This log was last generated on Wed, 25 Jun 2025 11:58:38 GMT and should not be manually modified.

## 4.6.4
Wed, 25 Jun 2025 11:58:38 GMT
...
- Add support for element tracking plugin
...
- Fix inactive button-click test
...
- Allow usage of Snowplow callback without 'this' keyword
...
- Add `performanceNavigationTiming` option to JS contexts config
...
- Adjust e2e tests for v2 Media support in YouTube plugin
- Revise default plugins
