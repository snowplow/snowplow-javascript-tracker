...
- Add new useExtendedCrossDomainLinker option
...
- Add CommonEventProperties type argument
- Update API docs with retryFailedRequests
- Add retryFailedRequests
